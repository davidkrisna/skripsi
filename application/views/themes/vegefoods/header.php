...
<html lang="en">
  <head>
	...
	<link rel="icon" href="<?php echo base_url('assets/uploads/sites/Logoo.png'); ?>">
	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
			  ...
			  <li class="nav-item"><a href="<?php echo site_url('pages/listproduct'); ?>" class="nav-link">Produk</a></li>
