      ...
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
          ...
          <div class="col-md-12 ftco-animate text-center">
            <h1 class="mb-2">Kami Hanya Menjual Sembako Yang Berkualitas</h1>
            <h2 class="subheading mb-4">Barang Barang Yang Segar dan Berkualitas</h2>
            <p><a href="<?php echo site_url('pages/listproduct') ;?>" class="btn btn-primary">Belanja Sekarang</a></p>
          </div>
      ...
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
          ...
          <div class="col-sm-12 ftco-animate text-center">
            <h1 class="mb-2">100% Berkualitas Dan Halal</h1>
            <h2 class="subheading mb-4">Tunggu Apalagi ?</h2>
            <p><a href=<?php echo site_url('pages/listproduct') ;?> class="btn btn-primary">Belanja Sekarang</a></p>
          </div>
...
<section class="ftco-section" id="products">
    ...
    <div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
      <div class="media block-6 services mb-md-0 mb-4">
        ...
        <div class="media-body">
          <h3 class="heading">Bahan Selalu Segar</h3>
          <span>Barang Baru Setiap Minggunya</span>
        </div>
      </div>    
    </div>
    <div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
      <div class="media block-6 services mb-md-0 mb-4">
        ...
        <div class="media-body">
          ...
          <span>Kualitas dari bahan bahan terbaik</span>
        </div>
      </div>      
    </div>
    <div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
      <div class="media block-6 services mb-md-0 mb-4">
        ...
        <div class="media-body">
          ...
          <span>Customer Service 24/7 Selalu Online</span>
        </div>
      </div>      
    </div>
  </div>
  ...
  <div class="container">
    ...
    <div class="col-md-6 heading-section ftco-animate deal-of-the-day ftco-animate">
        <h3 class="mb-4">Produk dengan Harga Terbaik</h3>
      <h2 class="mb-4">Deal of the day</h2>
      <h2 class="mb-4"><?php echo $best_deal->description; ?></h2>
